...
/**
 * Uses a stateless approach to embed the authenticator into a cookie.
 *
 * The stateless approach stores a serialized form of the authenticator in the cookie. It doesn't need a backing
 ...
 */
case class EmbedStatelessCookie[R](
