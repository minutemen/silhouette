 ...
 */
package com.mohiva.silhouette.persistence.repositories

import com.google.inject.{ AbstractModule, Guice, Provides }
import com.mohiva.silhouette.api.exceptions.ConfigurationException
import com.mohiva.silhouette.api.repositories.AuthInfoRepository
import com.mohiva.silhouette.api.util.PasswordInfo
import com.mohiva.silhouette.api.{ AuthInfo, LoginInfo }
import com.mohiva.silhouette.impl.providers.{ OAuth1Info, OAuth2Info }
import com.mohiva.silhouette.persistence.daos.{ DelegableAuthInfoDAO, InMemoryAuthInfoDAO }
import com.mohiva.silhouette.persistence.repositories.DelegableAuthInfoRepository._
...
class DelegableAuthInfoRepositorySpec(implicit ev: ExecutionEnv)
  ...
  trait Context extends Scope {
     ...
     * The Guice module.
     *
     * This is to test if the [[com.mohiva.silhouette.persistence.daos.DelegableAuthInfoDAO]] can be used for
