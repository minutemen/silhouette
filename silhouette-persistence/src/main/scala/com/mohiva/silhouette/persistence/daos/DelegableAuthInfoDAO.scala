...
import com.mohiva.silhouette.AuthInfo
 ...
 *
 * This abstract implementation of the [[com.mohiva.silhouette.persistence.daos.AuthInfoDAO]] trait
 * allows us to get the class tag of the auth info it is responsible for. Based on the class tag
 * the [[com.mohiva.silhouette.persistence.repositories.DelegableAuthInfoRepository]] class
